...
export const Sidebar = ({ isOpen, onClose, isCollapsed, onCollapsedChange, isMobile }: SidebarProps) => {
  ...
  const { currLogo, version, companyInfo } = useApp();
          ...
          <div className={styles.container}>
            <div className={styles.sidebarHeader}>
              ...
              <Link to="/" className={styles.logo} onClick={handleLinkClick}>
                {isCollapsed ? <img src={currLogo} alt="Logo" style={{ width: 35 }} /> : <img src={currLogo} alt="Logo" style={isMobile ? { width: 250 } : { width: 150 }} />}
              </Link>
            </div>

            <div className={styles.containerSidebar}>
              <SidebarMenu isCollapsed={isCollapsed || false} onLinkClick={handleLinkClick} isMobile={isMobile} />
