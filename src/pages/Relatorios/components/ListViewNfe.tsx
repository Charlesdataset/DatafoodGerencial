...
const ListViewNfe: React.FC = () => {
    ...
    useEffect(() => {
        fetchNfces();
        fetchTotais();
    }, [textSearch, status, valorInicial, valorFinal, periodoInicial, periodoFinal, saidaInicial, saidaFinal, limit, offset])
                ...
                return (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        {original.xmlAutorizacao && (
                            <Button variant="text" onClick={() => handleImprimirNfe(original.xmlAutorizacao)}>
    ...
    return (
        <>
            <Modal onClose={() => { setFiltersShow(false) }} isOpen={filtersShow}>
