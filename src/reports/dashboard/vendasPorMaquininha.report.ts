...
const handleReportVendasPorMaquininha = async (
  dataset: any,
  companyInfo: any,
      ...
      content: [
        {
          ...
          content: [
            {
              type: "text",
              value: "Relatório vendas por maquininha",
    ...
    content: [
      ...
      
      {
        ...
        tableHeader: [
          ...
          {key: "unit", prefix: "Qtd", align:'center', sum: true},
           {key: "price", prefix:"Valor", align:'center', sum: true},
          ],
           
        widths:[80, 'expand',60,60],
...
export default handleReportVendasPorMaquininha;
