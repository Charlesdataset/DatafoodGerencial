...
const handleReportVendasPorProduto = async (
  dataset: any,
  companyInfo: any,
      ...
      content: [
        {
          ...
          content: [
            {
              type: "text",
              value: "Relatório vendas por produto",
    ...
    content: [
      {
        ...
        keySum:'unit',
        topCount: 5,
        header: {value:'Top produtos mais vendidos (Qtd)', color: "#20435C", fontSize:12,align:'center'},
        width: 400,
        align:'center'
      },
      {
        ...
        content: [
          {
            type: 'chart',
            topCount: 5,
            header: {value: "Top produtos mais venderam (R$)", color: "#20435C", fontSize:12,},
            keyGroup: 'type',
            keyPresent: 'type',
            chartModel:'donut',
            dataset: 'produtos',
          ...
          },
          {
            type: 'chart',
            topCount: 5,
            header: {value: "Top produtos mais venderam (Qtd)", color: "#20435C", fontSize:12,},
            keyGroup: 'type',
            keyPresent: 'type',
            chartModel:'donut',
            dataset: 'produtos',
      ...
      {
        preHeader: {variable: 'Vendas por produto', color: "#20435C",fontSize: 12,},
        type: 'table',
        grandTotal:true,
      ...
      },
      {
        ...
        preHeader:{ variable:"Vendas agrupado por grupo", color: "#20435C",fontSize: 12},
        tableHeader: [
          { key: "id", prefix: 'Código', align:'center'}, 
          {key: 'title', prefix: "Descrição"},
          {key:'type', prefix: "Grupo"},
...
export default handleReportVendasPorProduto;
