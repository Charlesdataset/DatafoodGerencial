        ...
        ...(agrupadoPor !== NfceAgrupadoPor.Nenhum
          ? {
              grouping: {
                ...
                groupHeaderMask: agrupadoPor === NfceAgrupadoPor.DataEmissao || agrupadoPor === NfceAgrupadoPor.DataRecebimento || agrupadoPor === NfceAgrupadoPor.DataSaida ? 'date' : undefined,
                gap: 40,
                subtotal: true,
              },
            }
...
export default handleReportNfe;
